package com.itqiankun.ratelimit.guava.aspect;

import com.itqiankun.ratelimit.guava.annotation.RateLimiter;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.itqiankun.ratelimit.guava.annotation.RateLimiter)")
