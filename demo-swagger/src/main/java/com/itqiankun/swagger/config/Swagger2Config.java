package com.itqiankun.swagger.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.itqiankun.swagger.controller")).paths(PathSelectors.any()).build();
    }
