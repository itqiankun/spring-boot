...
> SQL 语句
>
> - DDL： `src/test/resources/table.sql`
...
> 测试用例：`com.itqiankun.oauth.oauth.AuthorizationCodeGrantTests`
...
> 测试用例：`com.itqiankun.oauth.oauth.ResourceOwnerPasswordGrantTests`
