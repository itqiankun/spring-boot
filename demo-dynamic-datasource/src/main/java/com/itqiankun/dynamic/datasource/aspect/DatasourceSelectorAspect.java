package com.itqiankun.dynamic.datasource.aspect;

import com.itqiankun.dynamic.datasource.annotation.DefaultDatasource;
import com.itqiankun.dynamic.datasource.datasource.DatasourceConfigContextHolder;
...
public class DatasourceSelectorAspect {
    @Pointcut("execution(public * com.itqiankun.dynamic.datasource.controller.*.*(..))")
