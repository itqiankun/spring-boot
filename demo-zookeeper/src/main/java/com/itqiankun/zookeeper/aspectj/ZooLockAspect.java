package com.itqiankun.zookeeper.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.itqiankun.zookeeper.annotation.LockKeyParam;
import com.itqiankun.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.itqiankun.zookeeper.annotation.ZooLock)")
    public void doLock() {
